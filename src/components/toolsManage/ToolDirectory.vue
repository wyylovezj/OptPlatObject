...
import { countLeafNodes, handleNodeClick, leafNodeCount, selectedNode, toolSTree } from '@/utils/publicDataTools.js'
...
const remove = (node, data) => {
  ElMessageBox.confirm(`确认要删除节点：${data.label}?`, '删除节点', {
    confirmButtonText: '确认',
    cancelButtonText: '取消',
    type: 'warning',
    icon: markRaw(Delete),
...
<template>
  <div class="toolsDirectory">
    ...
    <el-input v-model="filterText" class="w-60 mb-2" placeholder="搜索" style="margin-bottom: 20px" clearable />
